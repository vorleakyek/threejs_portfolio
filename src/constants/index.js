...
export const calculateSizes = (isSmall, isMobile, isTablet) => {
  return {
    deskScale: isSmall ? 3 : isMobile ? 5 : 9.5,
    deskPosition: isSmall ? [1.1, 1.5, 0.5] : isMobile ? [1.1, -1.5, 0.5] : [2.5, -9.5, -5.5]
  };
};
...
export const workExperiences = [
  {
    id: 1,
    name: 'Hack for LA',
    pos: 'Web Developer (volunteering)',
    duration: '2024 - Present',
    title: "Contributed to the VRMS project using JavaScript, React, Material-UI, Node.js, and MongoDB, ensuring code quality through pull request reviews, diagnosing website issues, and recommending solutions for improved performance and usability.",
    icon: '/assets/hack_for_la_logo.jpg',
    animation: 'victory',
  },
  {
    id: 2,
    name: 'MHE ALEKS',
    pos: 'Qality Assurance Specialist II',
    duration: '2020 - Present',
    title: "Collaborated with engineers, product managers, and the automation team in an agile environment to test 20+ features monthly on the ALEKS platform, ensuring high-quality releases through thorough functional, integration, and accessibility testing.",
    icon: '/assets/aleks.png',
    animation: 'clapping',
  },
  {
    id: 3,
    name: 'California State University, Long Beach',
    pos: 'Teaching Asscociate',
    duration: '2016 - 2018',
    title: "Taught a 'Modeling with Algebra' course to 28 students, covering linear, exponential, and logarithmic functions, while providing personalized feedback to support student learning and growth.",
    icon: '/assets/csulb.jpg',
    animation: 'salute',
  },
];
